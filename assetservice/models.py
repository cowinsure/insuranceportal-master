...
class Asset(models.Model):
    ...
    height = models.DecimalField(max_digits=6, decimal_places=2, help_text="height")
    ...
    special_mark = models.FileField(upload_to=asset_upload_path)
    health_issues = models.TextField(blank=True, null=True)
    pregnancy_status = models.TextField(blank=True, null=True)
    last_date_of_calving = models.DateField(blank=True, null=True)
    purchase_date = models.DateField(blank=True, null=True)
    purchase_from = models.TextField(blank=True, null=True)
    ...
    image_with_owner = models.FileField(upload_to=asset_upload_path)
    GENDER_CHOICES = (
        ('male', 'Male'),
        ('female', 'Female'),
        ('other', 'Other'),
