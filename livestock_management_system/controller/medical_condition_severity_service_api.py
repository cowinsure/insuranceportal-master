...
class MedicalConditionSeverityServiceAPIView(APIView):
    ...
    def get(self, request):
        try:
            record = build_request_with_user(AssetMedicalConditionSeverityRequest, request, method='GET')
            #record = AssetMedicalConditionSeverityRequest(**request.data)  # validation happens here        
